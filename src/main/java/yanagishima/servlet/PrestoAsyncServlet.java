...
public class PrestoAsyncServlet extends HttpServlet {
    ...
    @Inject
    public PrestoAsyncServlet(OldPrestoService oldPrestoService, PrestoService prestoService,
            YanagishimaConfig yanagishimaConfig) {
            ...
            queryOptional.ifPresent(query -> {
                ...
                try {
                    ...
                    if (yanagishimaConfig.isUseOldPresto(datasource)) {
                        queryid = oldPrestoService.doQueryAsync(datasource, query, userName, prestoUser,
                                prestoPassword);
                    } else {
